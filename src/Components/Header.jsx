...
import fondo from '../assets/Img/aguila.png'; 

const navigation = [
  { name: 'Dashboard', to: '/', current: true },
  { name: 'User administrator', to: '/User Admin', current: false },
  { name: 'Statics', to: '/Statics', current: false },
];
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as={Link}  // Utiliza el componente Link en lugar de 'a'
                  to={item.to}  // Utiliza el prop 'to' en lugar de 'href'
                  className={classNames(
